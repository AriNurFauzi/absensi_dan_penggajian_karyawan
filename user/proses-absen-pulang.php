...
$sql = "INSERT INTO absen_pulang (id_karyawan, NIK, tanggal_absensi, jam_keluar) 
        VALUES ('$karyawan_id', '$nik', '$tanggal_sql', '$jam')";

if (mysqli_query($conn, $sql)) {
    // Redirect ke halaman sukses
    header("Location: absen-pulang-berhasil.php?karyawan_id=$karyawan_id&waktu_absen=$waktu_absen&foto=" . urlencode($foto));
    exit;
} else {
