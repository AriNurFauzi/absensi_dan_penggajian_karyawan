...
if ($karyawan_id) {
    ...
    $query_absen = mysqli_query($conn, "SELECT jam_masuk FROM absensi WHERE id_karyawan = '$karyawan_id' ORDER BY Jam_masuk DESC LIMIT 1");
    if ($data_absen = mysqli_fetch_assoc($query_absen)) {
        date_default_timezone_set('Asia/Jakarta');
        $timestamp = strtotime($data_absen['jam_masuk']);
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="success-box">
      ✅ Absen Masuk Berhasil — Data absensi telah dicatat dalam sistem
    </div>

    <p style="font-size: 13px;">Jangan lupa untuk absen pulang setelah jam kerja selesai!</p>
